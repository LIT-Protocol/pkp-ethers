...
exports.verifyTypedData = exports.verifyMessage = exports.Wallet = exports.PKPWallet = void 0;
...
var PKPWallet = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.litNodeClient.executeJs({
                    ...
                    case 1:
                        res = _a.sent();
                        return [2 /*return*/, res.signatures[sigName]];
                }
            });
        });
    };
    Object.defineProperty(PKPWallet.prototype, "mnemonic", {
        get: function () {
    ...
    ;
    Object.defineProperty(PKPWallet.prototype, "privateKey", {
        get: function () {
    ...
    Object.defineProperty(PKPWallet.prototype, "publicKey", {
        get: function () {
    ...
    PKPWallet.prototype.getAddress = function () {
    ...
    PKPWallet.prototype.init = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.litNodeClient.connect()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 6:
                        ...
                        _e.label = 7;
                    case 7:
                        if (!!transaction['gasLimit']) return [3 /*break*/, 9];
                        _d = transaction;
                        return [4 /*yield*/, this.rpcProvider.estimateGas(transaction)];
                    case 8:
                        _d.gasLimit = _e.sent();
                        _e.label = 9;
                    case 9: return [2 /*return*/, (0, properties_1.resolveProperties)(transaction).then(function (tx) { return __awaiter(_this, void 0, void 0, function () {
    ...
    PKPWallet.prototype._signTypedData = function (domain, types, value) {
        return __awaiter(this, void 0, void 0, function () {
            var populated, toSign, signature;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    PKPWallet.prototype.encrypt = function (password, options, progressCallback) {
     ...
     */
    PKPWallet.createRandom = function (options) {
    ...
    PKPWallet.fromEncryptedJson = function (json, password, progressCallback) {
        return (0, json_wallets_1.decryptJsonWallet)(json, password, progressCallback).then(function (account) {
            return new Wallet(account);
        });
    };
    PKPWallet.fromEncryptedJsonSync = function (json, password) {
        return new Wallet((0, json_wallets_1.decryptJsonWalletSync)(json, password));
    };
    PKPWallet.fromMnemonic = function (mnemonic, path, wordlist) {
        if (!path) {
...
var Wallet = /** @class */ (function (_super) {
    ...
    Wallet.prototype.signTransaction = function (transaction) {
        ...
        return (0, properties_1.resolveProperties)(transaction).then(function (tx) { return __awaiter(_this, void 0, void 0, function () {
            var serializedTx, unsignedTxn, signature;
            return __generator(this, function (_a) {
                if (tx.from != null) {
                    if ((0, address_1.getAddress)(tx.from) !== this.address) {
                        logger.throwArgumentError("transaction from address mismatch", "transaction.from", transaction.from);
                ...
                serializedTx = (0, transactions_1.serialize)(tx);
                unsignedTxn = (0, keccak256_1.keccak256)(serializedTx);
                signature = this._signingKey().signDigest(unsignedTxn);
                console.log("signature", signature);
                return [2 /*return*/, (0, transactions_1.serialize)(tx, signature)];
            });
        }); });
